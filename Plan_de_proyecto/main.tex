...
\begin{document}
  ...
  \label{sec:introduccion}
    ...
    Documentar el \textit{plan de gestión} ejecutado para construir \textbf{\projectname}, una \textbf{plataforma Web2.5 de boletería} que combina la experiencia de usuario tradicional (catálogo de eventos, carrito, \textit{checkout} con pago fiat simulado y cuenta de usuario) con una capa \textbf{opcional} de propiedad Web3 implementada como \textbf{NFTs SEP-41} sobre la red \textbf{Stellar} mediante contratos inteligentes \textbf{Soroban}. El plan describe los procesos, roles, artefactos y mecanismos de control que se aplicaron durante el semestre académico \textbf{2026-1} (enero -- 24 de mayo de 2026) para entregar un prototipo funcional desplegado en \textit{testnet}, junto con la documentación académica requerida.

    \subsection{Audiencia y lectores}
    \begin{itemize}
      \item Miembros del equipo de proyecto (Grupo 12).
      \item Director de trabajo de grado: \textbf{Rafael Vicente Páez Méndez, PhD}.
      \item Docentes evaluadores y jurados del curso \textit{Planeación Proyecto Final} y del programa de Ingeniería de Sistemas.
      \item Revisores académicos de la Pontificia Universidad Javeriana.
    \end{itemize}

    \subsection{Alcance del documento}
    Este SPMP abarca:
    \begin{itemize}
      \item \textbf{Vista general} (Sección~\ref{sec:vista-general}): visión del producto, alcance entregado, objetivos cumplidos, supuestos, restricciones, entregables y resumen de calendarización y presupuesto.
      \item \textbf{Contexto del proyecto} (Sección~8): modelo de ciclo de vida ágil/Kanban, lenguajes y herramientas (Rust/Soroban, Node/Express/Prisma, React/Vite, Supabase, Vercel, Railway, Freighter Wallet), plan de aceptación del producto y organización del equipo.
      \item \textbf{Administración del proyecto} (Sección~9): métodos de estimación, plan de inicio, WBS, carta Gantt, asignación de recursos y presupuesto detallado.
      \item \textbf{Monitoreo y control} (Sección~10): administración de requerimientos, métricas de progreso, KPIs (cobertura de pruebas, eventos desplegados en \textit{testnet}, defectos abiertos) y cierre de fases.
      \item \textbf{Entrega del producto} (Sección~11): plan de transición y entrega al director y jurados.
      \item \textbf{Procesos de soporte} (Sección~12): análisis y administración de riesgos, gestión de configuración, métricas y control de calidad.
    \end{itemize}

    \subsection{Relación con otros artefactos}
    Este plan se integra con los siguientes documentos del trabajo de grado:
    \begin{itemize}
      \item \textbf{Memoria de TG:} documento principal del trabajo de grado que sintetiza problemática, marco teórico, metodología, resultados y conclusiones.
      \item \textbf{Propuesta de TG:} anteproyecto aprobado que define el alcance académico del trabajo.
      \item \textbf{SRS (Especificación de Requisitos de Software):} requisitos funcionales y no funcionales, historias de usuario y criterios de aceptación.
      \item \textbf{SDD (Especificación del Diseño):} vistas arquitectónicas C4, modelo de datos on-chain/off-chain, diagramas de secuencia y atributos de calidad.
      \item \textbf{Formato de Biblioteca:} formato institucional de entrega del trabajo de grado a la biblioteca de la Universidad.
      \item \textbf{Demo final:} producto desplegado en \textit{testnet} presentado en vivo ante el director y los jurados, o bien como \textbf{video} grabado del recorrido completo de la plataforma, junto con los enlaces públicos al repositorio del código fuente.
    \end{itemize}
    ...
    \begin{itemize}
      \item Para una \textbf{visión rápida del producto entregado}: leer Sección~\ref{sec:vista-general}.
      \item Para consultar \textbf{procesos, prácticas, herramientas y métricas}: revisar Secciones~8 a~12.
      \item Utilizar la \textbf{Tabla de Contenidos}, \textbf{Lista de Figuras} y \textbf{Lista de Tablas} para navegación directa.
      \item Los \textbf{hipervínculos internos} (azul) facilitan referencias cruzadas entre secciones, tablas y figuras.
    \end{itemize}
  ...
  \label{sec:descripcion-plan}
    ...
    \begin{itemize}
      \item \textbf{Sección~\ref{sec:vista-general} (Vista general del proyecto):} visión del producto entregado, propósito, alcance, objetivos, supuestos y restricciones, entregables y resumen de calendarización y presupuesto.
      \item \textbf{Sección 8 (Contexto del proyecto):} modelo de ciclo de vida ágil con tablero Kanban, lenguajes y herramientas (Rust/Soroban, Node/Express/Prisma, React/Vite, Supabase, Vercel, Railway, Freighter Wallet), plan de aceptación y estructura organizacional del equipo.
      \item \textbf{Sección 9 (Administración del proyecto):} métodos y herramientas de estimación; plan de inicio (entrenamiento en Soroban y configuración de infraestructura); planes de trabajo detallados (WBS, carta Gantt ejecutada, asignación de recursos y presupuesto).
      \item \textbf{Sección 10 (Monitoreo y control):} administración de requerimientos; seguimiento de progreso con métricas y KPIs (cobertura de pruebas, eventos desplegados, defectos abiertos); cierre de fases e iteraciones.
      \item \textbf{Sección 11 (Entrega del producto):} plan de transición y entrega al director y jurados; responsables y cronograma de artefactos finales.
      \item \textbf{Sección 12 (Procesos de soporte):} ambiente de trabajo y reglas de equipo; análisis y administración de riesgos materializados; gestión de configuración (Git, migraciones Prisma, despliegues); métricas y proceso de medición; control de calidad (verificación, validación, revisiones).
    \end{itemize}
  ...
  \label{sec:politicas}
    \begin{itemize}
      ...
      \item \textbf{Estructura y estilos:} el documento utiliza jerarquía de títulos (\texttt{\textbackslash section}, \texttt{\textbackslash subsection}, \texttt{\textbackslash subsubsection}) con numeración automática de \LaTeX. Figuras y tablas incluyen título descriptivo y fuente cuando aplique. Tamaño de letra en figuras/tablas: mínimo 10pt.
      ...
      \item \textbf{Trazabilidad:} cada plan, métrica o decisión referencia los artefactos relacionados (SRS, SDD, Memoria de TG) y las secciones del SPMP donde se detallan.
  ...
  \label{sec:contexto-proyecto}
    ...
    \label{subsec:ciclo-vida}
      ...
      El equipo adoptó un enfoque \textbf{ágil con tablero Kanban} sobre un ciclo de vida \textbf{incremental e iterativo}. La elección responde a tres factores específicos del proyecto:
      \begin{itemize}
  ...
  \label{sec:monitoreo-control}
    ...
    \subsection{Cierre de fases e iteraciones}
    \label{subsec:cierre-fases}
  ...
  \label{sec:procesos-soporte}
    ...
    \label{subsec:control-calidad}
      ...
      El control de calidad se apoya en tres mecanismos complementarios: \textbf{verificación} (¿lo estamos construyendo bien?), \textbf{validación} (¿estamos construyendo lo correcto?) y \textbf{revisiones} (inspección humana).
  ...
  \label{sec:cierre-proyecto}

    Esta sección consolida, de forma retrospectiva, el balance final del trabajo de grado al 24 de mayo de 2026. Recoge el cumplimiento de los compromisos, las lecciones aprendidas transversales, los riesgos residuales y las recomendaciones para una eventual continuación de \projectname.

    \subsection{Balance final del proyecto}
    \label{subsec:balance-final}

      Al cierre del semestre 2026-1, \projectname{} se entrega como un \textbf{prototipo Web2.5 funcional desplegado en \textit{testnet}} de Stellar, con los tres contratos Soroban operativos (\texttt{event\_contract}, \texttt{factory\_contract}, \texttt{ticket\_nft\_contract}), 12 eventos desplegados y verificables \textit{on-chain}, un backend Node/Express con indexer activo, un frontend React/Vite integrado con Freighter Wallet y un panel de administración (Phase 4) con roles diferenciados (ADMIN, ORGANIZADOR, STAFF, USER).

      \begin{itemize}
        \item \textbf{Alcance entregado:} 100\% de los objetivos comprometidos en la versión 1.0 del SPMP, más la incorporación de la \textbf{Phase 4} (panel administrativo y rol STAFF), no contemplada inicialmente.
        \item \textbf{Calidad técnica:} 58/58 pruebas de contratos aprobadas, 0 defectos críticos abiertos al cierre, cobertura del 100\% de funciones públicas de los contratos.
        \item \textbf{Documentación académica:} seis documentos entregados y validados con el director (Memoria de TG, Plan de Proyecto, SRS, SDD, Propuesta de TG y Formato de Biblioteca).
        \item \textbf{Cronograma:} 8/9 hitos cumplidos en fecha; el único desplazamiento (Backend + Indexer) se absorbió sin afectar la fecha de cierre.
        \item \textbf{Presupuesto:} ejecutado dentro del marco operativo planificado (servicios públicos del equipo, sin costos de infraestructura por uso de planes gratuitos de Supabase, Vercel y Railway y de la \textit{testnet} de Stellar).
      \end{itemize}

    \subsection{Cumplimiento de objetivos}
    \label{subsec:cumplimiento-objetivos}

      La Tabla~\ref{tab:cumplimiento-objetivos} resume el grado de cumplimiento de los objetivos comprometidos en la Sección~\ref{sec:vista-general}.
    ...
    \subsection{Lecciones aprendidas globales}
    \label{subsec:lecciones-globales}

      Más allá de las lecciones puntuales por fase (Sección~\ref{subsec:cierre-fases}), el equipo identifica las siguientes lecciones \textbf{transversales} al proyecto:

      \begin{itemize}
        \item \textbf{Web2.5 como propuesta de valor:} permitir al usuario operar sin billetera y luego \textit{opt-in} a la capa on-chain redujo enormemente la fricción de adopción y simplificó las pruebas de usabilidad con personas no técnicas.
        \item \textbf{Patrón XDR proxy \textit{stateless}:} desacoplar la construcción de transacciones (backend) de la firma (cliente con Freighter) eliminó la necesidad de custodiar llaves y simplificó la superficie de auditoría.
        \item \textbf{Indexer como puente:} mantener un indexer sincronizando estado on-chain $\rightarrow$ PostgreSQL fue clave para servir vistas rápidas al frontend sin sacrificar la fuente de verdad criptográfica.
        \item \textbf{Kanban con WIP limitado} resultó más adecuado que sprints fijos para un equipo de cinco con horarios académicos heterogéneos.
        \item \textbf{Revisiones semanales con el director:} actuaron como mecanismo de control de alcance y validación temprana; el desplazamiento de un solo hito se atribuye en parte a este ritmo de retroalimentación.
        \item \textbf{Documentación viva:} actualizar el SPMP, el SRS y el SDD al final de cada fase (no solo al inicio) evitó la divergencia entre documento entregado y sistema construido.
        \item \textbf{Curva de aprendizaje de Soroban/Rust:} subestimada inicialmente; en proyectos futuros conviene reservar un \textit{spike} técnico explícito antes de comprometer fechas de entrega.
      \end{itemize}

    \subsection{Riesgos residuales y trabajo futuro}
    \label{subsec:riesgos-residuales}

      El prototipo entregado funciona en \textit{testnet} y cumple los criterios de aceptación académicos. Para una eventual evolución hacia un producto operativo se identifican los siguientes \textbf{riesgos residuales} y \textbf{líneas de trabajo futuro}:

      \begin{itemize}
        \item \textbf{Migración a \textit{mainnet}:} requiere auditoría externa de los tres contratos Soroban, plan de manejo de incidentes y procedimientos de actualización (\textit{upgradeability}) antes de mover valor real.
        \item \textbf{Pasarela de pagos real:} el \textit{checkout} fiat es simulado; integrar una pasarela (Stripe, PayU u otra) implica cumplimiento PCI-DSS y rediseño del flujo de conciliación con on-chain.
        \item \textbf{Escalabilidad del indexer:} el indexer actual opera con \textit{polling} cada 5 s sobre el RPC de Soroban; para volúmenes mayores conviene migrar a un esquema basado en \textit{webhooks} o a un servicio gestionado.
        \item \textbf{Experiencia de usuario sin billetera:} aunque la capa Web3 es opcional, una eventual versión de producción debe ofrecer custodia opcional (billetera gestionada) para usuarios que prefieran no instalar Freighter.
        \item \textbf{Internacionalización y accesibilidad (WCAG):} ambos quedaron fuera de alcance del prototipo académico y deben abordarse antes de un lanzamiento público.
        \item \textbf{Modelo de negocio sostenible:} definir la estructura de comisiones (organizador / plataforma / reventa) en función de los costos operativos reales de \textit{mainnet} y de pasarela de pagos.
      \end{itemize}

    \subsection{Cierre formal del SPMP}
    \label{subsec:cierre-formal-spmp}

      Con la entrega de la versión \textbf{1.5} de este Plan de Gestión del Proyecto (21 de mayo de 2026) y de los demás artefactos académicos asociados, el equipo declara \textbf{cerrado} el ciclo de gestión del trabajo de grado \projectname{} correspondiente al semestre 2026-1.

      \begin{itemize}
        \item \textbf{Estado del repositorio:} congelado en la rama \texttt{main}; \textit{tag} de cierre \texttt{v1.0-tg-cierre} aplicado el 24 de mayo de 2026.
        \item \textbf{Estado de la infraestructura:} servicios desplegados (Vercel, Railway, Supabase, contratos en \textit{testnet}) se mantienen activos para la sustentación; su desmantelamiento posterior queda a discreción del equipo y del director.
        \item \textbf{Custodia documental:} los seis documentos del trabajo de grado se entregan a la biblioteca de la Pontificia Universidad Javeriana conforme al Formato de Biblioteca.
        \item \textbf{Responsabilidad post-cierre:} el equipo no compromete soporte ni mantenimiento posterior a la sustentación; cualquier evolución posterior se considera fuera del alcance del trabajo de grado.
      \end{itemize}

      Este Plan deja registro trazable y medible del proceso ejecutado, en concordancia con IEEE Std 1058-1998 y con las directrices del curso de \textit{Planeación Proyecto Final} de la Pontificia Universidad Javeriana.

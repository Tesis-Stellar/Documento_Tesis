...
\begin{document}
  ...
  \textbf{Relación con artefactos.} Este SPMP se coordina con los demás documentos del trabajo de grado: Memoria de TG, Propuesta de TG, Especificación de Requisitos de Software (SRS), Especificación del Diseño (SDD), Plan de Pruebas/AUT-UAT y el Demo final.

  \textbf{Convenciones.} La terminología se mantiene alineada con el glosario técnico del proyecto. Para el flujo de ingreso se usa ``verificación QR DB-first en puerta''; ``redención on-chain contractual'' se reserva para la capacidad del contrato.
  ...
  \label{sec:vista-general}
    ...
    \begin{itemize}
      ...
      \item \textbf{Verificación en puerta:} sólo verificadores autorizados pueden operar el escáner QR DB-first; la redención on-chain queda cubierta como capacidad contractual.
    \end{itemize}
    ...
    \label{subsec:proposito-alcance}
      ...
      Construir un \textbf{prototipo académico funcional} que evidencie la viabilidad técnica de una plataforma de boletería Web2.5, integrando catálogo y carrito tradicionales con contratos inteligentes Soroban para la emisión de NFTs SEP-41, reventa atómica con comisiones programables y verificación QR DB-first en puerta. El prototipo se desplegó en la \textit{testnet} de Stellar y constituye la demostración del modelo ante el director y los jurados del trabajo de grado.
      ...
      \begin{itemize}
        ...
        \item \textbf{Documentación académica:} Memoria de TG, este SPMP (Plan de Proyecto), SRS, SDD, Propuesta de TG, Plan de Pruebas/AUT-UAT y Demo final.
      \end{itemize}
      ...
      \begin{enumerate}
        ...
        \item \textbf{Producir} la documentación académica del trabajo de grado: Memoria de TG, Plan de Proyecto (este SPMP), SRS, SDD, Propuesta de TG y Plan de Pruebas/AUT-UAT.
      \end{enumerate}
    ...
    Los entregables del proyecto se clasifican en artefactos de software y artefactos de documentación.
      ...
      \begin{enumerate}
        ...
        \item \textbf{Plan de Pruebas/AUT-UAT:} estrategia de validación, casos de prueba y evidencias de aceptación de usuario.
      \end{enumerate}
    ...
    \label{subsec:resumen-calendario-presupuesto}
      ...
      \begin{longtable}{@{}p{3.0cm} p{5.2cm} p{2.8cm} p{3.2cm}@{}}
        ...
        \midrule
        Documentación final & Cierre de Memoria de TG, SDD, SRS, SPMP v1.5, Propuesta de TG y Plan de Pruebas/AUT-UAT; preparación del Demo final & Sem.~15--16 (may 11 -- may 23) & Todos (PM coordina)\\
        \midrule
  ...
  \label{sec:contexto-proyecto}
    ...
    \label{subsec:herramientas}
      ...
      \begin{itemize}
        ...
        \item \textbf{SQL} (PostgreSQL 16 en Supabase): consultas analíticas y migraciones gestionadas con Prisma.
      \end{itemize}
      ...
      \begin{longtable}{@{}p{3.3cm} p{4.0cm} p{7.5cm}@{}}
        ...
        Datos & PostgreSQL 16 (Supabase) & Base de datos transaccional \textit{off-chain}.\\
        ...
        Documentación & \LaTeX{} (MiKTeX, TeXstudio) & Memoria de TG, Plan de Proyecto, SRS, SDD, Propuesta y Plan de Pruebas/AUT-UAT.\\
    ...
    \label{subsec:plan-aceptacion}
      ...
      \begin{enumerate}
        ...
        \item \textbf{Aceptación final (entrega y sustentación):} entrega del paquete final de seis documentos (Memoria, Plan de Proyecto, SRS, SDD, Propuesta y Plan de Pruebas/AUT-UAT) a la coordinación académica el \textbf{24 de mayo de 2026}, y posterior sustentación ante el director y los jurados del trabajo de grado en una fecha asignada por la coordinación dentro de la ventana \textbf{25 de mayo -- 5 de junio de 2026}, con el sistema desplegado en \textit{testnet}.
      \end{enumerate}
      ...
      \begin{itemize}
        \item \textbf{Suite de contratos desplegada:} tres contratos Soroban desplegados en \textit{testnet} con direcciones verificables y al menos un evento operativo.
        \item \textbf{Flujo E2E completo:} un usuario autenticado puede navegar el catálogo, comprar un boleto (Web2), asegurarlo on-chain (Web3), revenderlo a otro usuario (\textit{burn}/\textit{remint} con comisiones) y un verificador autorizado puede verificarlo en puerta mediante escáner QR DB-first.
    ...
    \label{subsec:organizacion}
      ...
      \begin{longtable}{@{}p{4.8cm} c c c c c@{}}
        ...
        Plan de Pruebas/AUT-UAT & R & C & C & C & A\\
  ...
  \label{sec:monitoreo-control}
    ...
    \label{subsec:admin-requerimientos}
      ...
      \begin{longtable}{@{}p{2.0cm} p{6.0cm} p{6.6cm}@{}}
        ...
        May.~2026 & Reclasificación de documentos de soporte & Reorganización del paquete documental final a seis documentos académicos (Memoria, Plan de Proyecto, SRS, SDD, Propuesta y Plan de Pruebas/AUT-UAT). La Guía de Despliegue, el Manual de Usuario y el Póster se consolidaron en la Memoria y el Demo final.\\
      \end{longtable}
    ...
    \label{subsec:cierre-proyecto}
      ...
      \begin{longtable}{@{}p{8.5cm} p{2.2cm} p{4.0cm}@{}}
        ...
        Implementar verificación QR DB-first en puerta vía rol STAFF/Verificador y validar redención on-chain a nivel contractual. & Cumplido & Phase 4; escáner operativo y pruebas de contrato.\\
  ...
  \label{sec:entrega-producto}
    ...
    \label{subsec:artefactos-entrega}
      ...
      \begin{longtable}{@{}p{4.5cm} p{4.0cm} p{3.0cm} p{3.0cm}@{}}
        ...
        Plan de Pruebas/AUT-UAT & Plan de validación y evidencias de aceptación & PDF (\LaTeX) & Todos\\
      ...
      \textbf{Aclaraciones:}
      \begin{itemize}
        \item Sólo los \textbf{seis documentos} (Memoria, Plan de Proyecto, SRS, SDD, Propuesta y Plan de Pruebas/AUT-UAT) se entregan formalmente a la coordinación académica.
  ...
  \label{sec:procesos-soporte}
    ...
    \label{subsec:gestion-configuracion}
      ...
      \begin{itemize}
        ...
        \item \textbf{Documentos académicos:} fuentes \LaTeX{} de Memoria de TG, SPMP, SRS, SDD, Propuesta y Plan de Pruebas/AUT-UAT, junto con sus imágenes/diagramas.
